...
-- Insert test users (5 samples) - COMMENTED OUT - seed-data.js will populate instead
...
-- Insert sample flights (10 samples) - COMMENTED OUT - seed-data.js will populate instead
...
-- Insert sample hotels (10 samples) - COMMENTED OUT - seed-data.js will populate instead
...
-- Insert hotel rooms for each hotel - COMMENTED OUT - seed-data.js will populate instead
...
-- Insert hotel amenities - COMMENTED OUT - seed-data.js will populate instead
...
-- Insert sample cars (10 samples) - COMMENTED OUT - seed-data.js will populate instead
