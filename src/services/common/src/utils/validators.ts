 ...
 */
export function validateFutureDate(date: string, fieldName: string = 'Date'): { valid: boolean; error?: string } {
 ...
 */
export function validateCardExpiry(expiryDate: string): { valid: boolean; error?: string } {
 ...
 */
export function assertValid(validation: { valid: boolean; error?: string }): void {
  if (!validation.valid) {
